...
export function TimetablePageContent() {
  ...
  const initialHeadsign = searchParams.get('headsign') ?? undefined

  return <TimetableController stopName={stopName} provider={provider} initialHeadsign={initialHeadsign} />
}
